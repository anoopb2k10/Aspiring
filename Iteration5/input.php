...
<!-- Function for generating arguements in a table-->
...
<body>
	<form method="post" action="backend.php">
		...
		<!--It will call the above function for Arguement list generation-->
